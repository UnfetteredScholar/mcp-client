...
from schemas import conversation as s_conversation
...
class MongoStorage(Generic[T]):
    ...
    def get_all(self, filter: Dict, limit: int = 0, sort: dict = {"_id": 1}) -> List[T]:
...
conversations = MongoStorage(
    collection_name="conversations",
    model=s_conversation.Conversation,
